...
public class TwentyEight {
	...
	public class DataStorageManager extends ActiveWFObject
	{
		...
		public void _process_words(List<Object> message)
		{
			...
			for(String word: words)
			{
				...
				new_msg.add("filter");
				new_msg.add(word);
				send(this.stopwordmanager, new_msg);
			}
	...
	public class StopWordManager extends ActiveWFObject
	{
		...
		public void _dispatch(List<Object> message)
		{
			...
			else if(msg.compareToIgnoreCase("filter") == 0)
			{
				_filter(message.subList(1, message.size()));
			}
			else
			{
				//forward
		...
		public void _init(List<Object> message)
		{
			try
			{
				...
				this._word_freqs_manager = (WordFrequencyManager) message.get(0);
			}
	...
	public static void main(String[] args) {
		...
		StopWordManager stop_word_manager = te.new StopWordManager();
		
		List<Object> msg1 = new ArrayList<Object>();
		msg1.add("init");
		msg1.add(word_freq_manager);

		te.send(stop_word_manager, msg1);
